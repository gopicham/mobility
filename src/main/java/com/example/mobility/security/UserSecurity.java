 ...
 * @author Luke Taylor
 */
public class UserSecurity implements UserDetails, CredentialsContainer {
	...
	public static final class UserBuilder {
		...
		public UserDetails build() {
			...
			return new UserSecurity(this.username, encodedPassword, !this.disabled, !this.accountExpired,
